/*
SDL 2 code source for Visual Source Coded by Frédéric Sagez in 2022
...
- Logo Koelis (BMP file 100x100 px) file :: logoA.bmp
*/
...
int main(int argc, char** argv)
{
    ...
    while (!quit){
        ...
        // FPS= 1000/Nombre(ms) donc 30fps= 1000/33 soit 50fps=1000/20
        ...
        // Couleur du texte suivant le temps machine utlisé
        if ( elapsedMS >= 49 ) {
            textcolor.r = 0; // noir
            textcolor.g = 0;
            textcolor.b = 0;
